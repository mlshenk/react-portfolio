  ...
  return (
    ...
    <section className="container">
      ...
      <article className="bio row justify-content-sm-center">  
        ...
        <br></br>
        <br></br>
        With this full-stack web development certificate, I have honed my skills in React.js, MongoDB, JavaScript, and MySQL/Sequelize, among many others. I also have experience building full CRUD and MERN applications that are mobile-responsive and intuitive. I look forward to combining these traits with my technical training to provide innovative user-friendly products, develop efficient user experiences, and help my future company drive growth.
        </p>
      </article>
    </section>
    </>
